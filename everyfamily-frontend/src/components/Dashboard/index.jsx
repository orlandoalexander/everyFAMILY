          ...
          <div>
            ...
            <ul className="capo-list">
              <li className="capo-item">
                ...
                training for professionals (police, prisons, probation, health,
                social care, education) who work directly with families impacted
                by parental offending and imprisonment.
              </li>
              <li className="capo-item">
                <span className="capo-label">Support &amp; Resources:</span> We
                serve as a point of contact for professionals seeking support or
                resources for families they are assisting.
              </li>
              <li className="capo-item">
                <span className="capo-label">CAPO Champions:</span> We
                facilitate a network of “CAPO Champions” – professionals across
                the region who can connect for CPD training, networking, and
                best practice sharing. Champions are the significant point of
                contact within their setting for those wishing to access CAPO
                support.
              </li>
              <li className="capo-item">
                ...
                (The Golden Thread – The Centre for Social Justice) has shown to
            ...
            <ul className="capo-list">
              ...
              <li>Guiding them on how to address the children’s questions.</li>
              <li>
            ...
            <div className="capo-text">
              ...
              <p>
                <strong>everyFAMILY</strong> serve as the nominated charity for{" "}
                <strong>Operation Paramount in Bristol</strong>. This pilot, in
                partnership with Avon and Somerset Police, starting in July
                2025, will aim to rapidly identify children with a parent in
                prison, targeting a swift offer of support for the whole family.
              </p>
